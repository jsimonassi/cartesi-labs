...
export const Card = ({ info, onStartRequest }: CardProps) => {
	return (
        ...
        Last Updated: {moment(info.updatedAt).format("DD/MM/YYYY")}
			...
			<div className="flex justify-between self-end pr-2 items-center mt-auto">
				<button
					className="outline-none border border-primary text-primary rounded px-3 py-1 w-24 mb-2 mr-2"
